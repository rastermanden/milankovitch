...
const STRINGS = {
  en: {
    ...
    'ice.none': 'none',
    'time.now': 'now',
    'chart.peaks': '≈ interglacial peaks',
    'chart.unit': 'kyr',
...
const PAGE = {
  da: {
    ...
    'time.lgm': 'Istidsmaksimum −21.000 år',
    'time.holocene': 'Holocæn begynder −11.700 år',
    'time.eemian': 'Sidste varmeperiode −125.000 år',
    'time.mis11': 'Lang mellemistid −405.000 år',
    'time.next': 'Om ~50.000 år',
    'ro.e': 'Excentricitet',
    'ro.eps': 'Aksehældning',
    'ro.prec': 'Præcessionsindeks',
    'time.chart': 'Tidsserier for excentricitet, aksehældning, præcessionsindeks, midsommersol ved 65°N, modelleret albedo og den resulterende Stefan–Boltzmann-ændring i overfladetemperatur fra 800.000 år siden til 100.000 år frem. Træk for at spole i tiden; brug piletasterne til at gå trinvist.',
    'time.chartHint': 'Trekanterne markerer omtrentlige varme mellemistidstoppe i det marine isotoparkiv. Læg mærke til, hvordan varmeperioderne falder sammen med stærk midsommersol, og hvor stille solkurven bliver, når banen er rund (lav excentricitet, omkring −400.000 år og i dag). Nederste panel er den temperatur, Stefan–Boltzmann-balancen tildeler den modellerede albedo, kun Planck-respons; se <a href="#energy">nedenfor</a>.',
    ...
    'model.sources': 'Videre læsning: Hays, Imbrie &amp; Shackleton, <i>Variations in the Earth\'s Orbit: Pacemaker of the Ice Ages</i>, Science (1976) · Laskar et al., <i>A long-term numerical solution for the insolation quantities of the Earth</i>, A&amp;A (2004) · M. Milanković, <i>Kanon der Erdbestrahlung</i> (1941).',
